...
class __TwigTemplate_2ebd4f53a7434ce4583c0a91c659bc8c extends Template
{
...
/**
 * @file
 * Theme override for a \x27textarea\x27 #type form element.
 *
 * Available variables
...
{%
  set classes = [
    \x27form-textarea\x27,
    resizable ? \x27resize-\x27 ~ resizable,
    required ? \x27required\x27,
    \x27form-element\x27,
    \x27form-element--type-textarea\x27,
    \x27form-element--api-textarea\x27,
  ]
%}
<div{{ wrapper_attributes.addClass(\x27form-textarea-wrapper\x27) }}>
