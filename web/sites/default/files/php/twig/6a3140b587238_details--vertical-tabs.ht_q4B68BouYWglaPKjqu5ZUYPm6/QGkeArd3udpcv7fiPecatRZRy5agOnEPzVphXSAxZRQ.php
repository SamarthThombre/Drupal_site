...
class __TwigTemplate_11ed72ed5f0c035ded221d3840926b27 extends Template
{
...
{%
  set classes = [
    \x27claro-details\x27,
    \x27claro-details--vertical-tabs-item\x27,
  ]
%}
{%
  set content_wrapper_classes = [
    \x27claro-details__wrapper\x27,
    \x27details-wrapper\x27,
    \x27claro-details__wrapper--vertical-tabs-item\x27,
  ]
%}
{%
  set inner_wrapper_classes = [
    \x27claro-details__content\x27,
    \x27claro-details__content--vertical-tabs-item\x27,
  ]
%}
<details{{ attributes.addClass(classes) }}>
  {%- if title -%}
    {%
      set summary_classes = [
        \x27claro-details__summary\x27,
        \x27claro-details__summary--vertical-tabs-item\x27,
