...
/* themes/icar_theme/templates/form/form-element-label.html.twig */
class __TwigTemplate_808eca81a2c73530e8dcb47d43fd79e4 extends Template
{
...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
    ...
    {
        return "themes/icar_theme/templates/form/form-element-label.html.twig";
    }
 ...
 *
 * Available variables:
 * - title: The label\x27s text.
 * - title_display: Elements title_display setting.
 * - required: An indicator for whether the associated form element is required.
 * - attributes: A list of HTML attributes for the label.
 *
 * @see\\Drupal\\Core\\Form\\FormPreprocess::preprocessFormElementLabel()
 */
#}
{%
  set classes = [
    title_display == \x27after\x27 ? \x27option\x27,
    title_display == \x27invisible\x27 ? \x27visually-hidden\x27,
    required ? \x27js-form-required\x27,
    required ? \x27form-required\x27,
  ]
%}
{% if title is not empty or required -%}
  <label{{ attributes.addClass(classes) }}>{{ title }}</label>
{%- endif %}
", "themes/icar_theme/templates/form/form-element-label.html.twig", "/var/www/html/web/themes/icar_theme/templates/form/form-element-label.html.twig");
    }
