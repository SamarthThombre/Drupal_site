...
class __TwigTemplate_b3519356e0d83c7bd063606aaa34558d extends Template
{
...
/**
 * @file
 * Claro\x27s theme implementation for the content of an administrative block.
 *
 * Available variables:
 ...
 *
 * @see \\Drupal\\system\\Theme\\SystemAdminThemePreprocess::preprocessAdminBlockContent()
...
%}
{% if content %}
  <dl{{ attributes.addClass(\x27admin-list\x27) }}>
    {% for item in content %}
