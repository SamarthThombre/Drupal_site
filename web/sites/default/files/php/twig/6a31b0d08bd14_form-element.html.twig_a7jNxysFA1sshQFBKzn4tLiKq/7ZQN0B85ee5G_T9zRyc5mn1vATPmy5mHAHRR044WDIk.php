...
class __TwigTemplate_eb9a4612df65753d9829e78ee309a5c9 extends Template
{
...
{%
  set classes = [
    ...
    type in [\x27checkbox\x27, \x27radio\x27] ? \x27form-type--boolean\x27,
    \x27js-form-item-\x27 ~ name|clean_class,
    \x27form-item--\x27 ~ name|clean_class,
    title_display not in [\x27after\x27, \x27before\x27] ? \x27form-item--no-label\x27,
    disabled == \x27disabled\x27 ? \x27form-item--disabled\x27,
    errors ? \x27form-item--error\x27,
  ]
%}
{%
  set description_classes = [
    \x27form-item__description\x27,
...
<div{{ attributes.addClass(classes) }}>
  ...
  {% if prefix is not empty %}
    <span class=\"form-item__prefix{{ disabled == \x27disabled\x27 ? \x27 is-disabled\x27 }}\">{{ prefix }}</span>
  {% endif %}
  {{ children }}
  {% if suffix is not empty %}
    <span class=\"form-item__suffix{{ disabled == \x27disabled\x27 ? \x27 is-disabled\x27 }}\">{{ suffix }}</span>
  {% endif %}
