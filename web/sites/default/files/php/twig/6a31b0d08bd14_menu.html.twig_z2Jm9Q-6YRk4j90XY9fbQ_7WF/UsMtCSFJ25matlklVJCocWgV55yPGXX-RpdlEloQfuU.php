...
/* themes/icar_theme/templates/navigation/menu.html.twig */
class __TwigTemplate_cdaa85d9b62e0244f911338370236f9c extends Template
{
...
$context["item"], "in_active_trail", [], "any", false, false, true, 43)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("menu-item--active-trail") : (""))];
  ...
  ";
    ...
    {
        return "themes/icar_theme/templates/navigation/menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level) %}
  ...
  {% if items %}
    {% if menu_level == 0 %}
      <ul{{ attributes.addClass(\x27menu\x27) }}>
    {% else %}
      <ul class=\"menu\">
    {% endif %}
    {% for item in items %}
      {%
        set classes = [
          \x27menu-item\x27,
          item.is_expanded ? \x27menu-item--expanded\x27,
          item.is_collapsed ? \x27menu-item--collapsed\x27,
          item.in_active_trail ? \x27menu-item--active-trail\x27,
        ]
      %}
  ...
  {% endif %}
{% endmacro %}
", "themes/icar_theme/templates/navigation/menu.html.twig", "/var/www/html/web/themes/icar_theme/templates/navigation/menu.html.twig");
    }
