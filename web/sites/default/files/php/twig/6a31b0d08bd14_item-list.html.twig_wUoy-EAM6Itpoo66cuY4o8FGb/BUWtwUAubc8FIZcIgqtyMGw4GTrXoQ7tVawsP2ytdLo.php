...
class __TwigTemplate_77bd9e8aa17be9b97b55c82a5cf311c8 extends Template
{
...
{% if context.list_style %}
  {%- set wrapper_attributes = wrapper_attributes.addClass(\x27item-list--\x27 ~ context.list_style) %}
  {%- set attributes = attributes.addClass(\x27item-list__\x27 ~ context.list_style) %}
{% endif %}
{% if items or empty -%}
  <div{{ wrapper_attributes.addClass(\x27item-list\x27) }}>
