...
class __TwigTemplate_793335e1c7d1240e6d81f0b502278a41 extends Template
{
 ...
 */
#}
<div{{ attributes.addClass(\x27toolbar\x27, \x27claro-toolbar\x27) }}>
  <nav{{ toolbar_attributes.addClass(\x27toolbar-bar\x27, \x27clearfix\x27) }}>
    <h2 class=\"visually-hidden\">{{ toolbar_heading }}</h2>
    {% for key, tab in tabs %}
      {% set tray = trays[key] %}
      <div{{ tab.attributes.addClass(\x27toolbar-tab\x27) }}>
        {{ tab.link }}
        <div{{ tray.attributes }}>
          {% if tray.label %}
