...
class __TwigTemplate_cdd6c66274435f560e0b7223472cffc5 extends Template
{
...
{%
  set classes = [
    \x27tabs__tab\x27,
    level == \x27primary\x27 ? \x27js-tab\x27,
    is_active ? \x27is-active\x27,
    is_active ? \x27js-active-tab\x27,
  ]
%}
<li{{ attributes.addClass(classes) }}>
  {{ link }}
  {% if is_active and level == \x27primary\x27 %}
    {{ attach_library(\x27core/drupal.reset-appearance\x27) }}
    <button class=\"reset-appearance tabs__trigger\" type=\"button\" aria-label=\"{{ \x27Tabs display toggle\x27|t }}\" data-drupal-nav-tabs-trigger>
