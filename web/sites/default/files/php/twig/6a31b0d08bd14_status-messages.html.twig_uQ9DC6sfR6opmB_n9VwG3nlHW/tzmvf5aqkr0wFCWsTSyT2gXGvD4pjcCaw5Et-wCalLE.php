...
class __TwigTemplate_ee648185a937f1eb9625a81b7b7fd795 extends Template
{
...
<div data-drupal-messages class=\"messages-list\">
  <div class=\"messages-list__wrapper\">
    {% for type, messages in message_list %}
      {%
        set classes = [
          \x27messages-list__item\x27,
          \x27messages\x27,
          \x27messages--\x27 ~ type,
        ]
      %}
      {%
      ...
      %}
      {%
        set is_message_with_icon = type in [\x27error\x27, \x27status\x27, \x27warning\x27]
      %}

      <div role=\"contentinfo\" aria-labelledby=\"{{ title_ids[type] }}\"{{ attributes.addClass(classes)|without(\x27role\x27, \x27aria-label\x27) }}>
        {% if type == \x27error\x27 %}
          <div role=\"alert\">
        {% endif %}
